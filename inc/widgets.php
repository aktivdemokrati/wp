...
function ad_sidebars_init()
{
  register_sidebar( array(
			  'name' => __( 'Primary Widget Area', 'ad' ),
			  'id' => 'primary-widget-area',
			  'description' => __( 'The primary widget area', 'ad' ),
  ...
  register_sidebar( array(
			  'name' => __( 'Secondary Widget Area', 'ad' ),
			  'id' => 'secondary-widget-area',
			  'description' => __( 'The secondary widget area', 'ad' ),
			  'before_widget' => '<li id="%1$s" class="widget-container %2$s">',
			  'after_widget' => '</li>',
			  'before_title' => '<h3 class="widget-title">',
			  'after_title' => '</h3>',
  ...
  register_sidebar( array(
			  'name' => __( 'Tertiary Widget Area', 'ad' ),
			  'id' => 'tertiary-widget-area',
			  'description' => __( 'The Tertiary widget area', 'ad' ),
			  'before_widget' => '<li id="%1$s" class="widget-container %2$s">',
			  'after_widget' => '</li>',
			  'before_title' => '<h3 class="widget-title">',
			  'after_title' => '</h3>',
  ...
  register_sidebar( array(
			  'name' => __( 'First Footer Widget Area', 'ad' ),
			  'id' => 'first-footer-widget-area',
			  'description' => __( 'The first footer widget area', 'ad' ),
			  'before_widget' => '<li id="%1$s" class="widget-container %2$s">',
			  'after_widget' => '</li>',
			  'before_title' => '<h3 class="widget-title">',
			  'after_title' => '</h3>',
  ...
  register_sidebar( array(
			  'name' => __( 'Front Page Widget Area', 'ad' ),
			  'id' => 'front-page-widget-area',
			  'description' => __( 'Special widget area used on the right side on the front page', 'ad' ),
			  'before_widget' => '<li id="%1$s" class="widget-container %2$s">',
			  'after_widget' => '</li>',
			  'before_title' => '<h3 class="widget-title">',
			  'after_title' => '</h3>',
...
/*
 * Translation of wp-content/plugins/wp-fb-autoconnect/Main.php
 */
function ad_jfb_output_facebook_btn()
{
    ...
    <?php 
    $btnTag = "document.write('<fb:login-button v=\"2\" size=\"small\" onlogin=\"$jfb_js_callbackfunc();\">Logga in</fb:login-button>');";  
